...
#include "ubreco/LLSelectionTool/OpT0Finder/Base/BaseFlashFilter.h"
#include "ubreco/LLSelectionTool/OpT0Finder/Base/FlashFilterFactory.h"

namespace flashana {
  /**
     \class MaxNPEWindow
     Type flashana::BaseFlashFilter algorithm class. It applies a very simple  \n
