...
FlashNeutrinoId::FlashNeutrinoId(fhicl::ParameterSet const &pset) : m_flashLabel(pset.get<std::string>("FlashLabel")),
                                                                    ...
                                                                    // m_classicdqdscalc(pset.get<fhicl::ParameterSet>("ClassicDqDsCalculator")),
                                                                    // m_classicdqdssmooth(pset.get<fhicl::ParameterSet>("ClassicDqDsSmoother")),
                                                                    // m_classichitorder(pset.get<fhicl::ParameterSet>("ClassicHitOrderer")),
                                                                    // m_classichitsmooth(pset.get<fhicl::ParameterSet>("ClassicHitSmoother")),
                                                                    // m_classiclocallincalc(pset.get<fhicl::ParameterSet>("ClassicLocalLinearityCalculator")),
                                                                    // m_classicstarthitfinder(pset.get<fhicl::ParameterSet>("ClassicStartHitFinder")),
                                                                    // m_stopmubragg(pset.get<fhicl::ParameterSet>("StopMuBragg")),
                                                                    // m_stopmumichel(pset.get<fhicl::ParameterSet>("StopMuMichel")),
