...
// File:        ACPTtrigLightStudies_module.cc
//
...
class ACPTtrigLightStudies;


class ACPTtrigLightStudies : public art::EDFilter {
public:
  explicit ACPTtrigLightStudies(fhicl::ParameterSet const& p);
  // The compiler-generated destructor is fine for non-base
  // classes without bare pointers or other resource use.

  // Plugins should not be copied or assigned.
  ACPTtrigLightStudies(ACPTtrigLightStudies const&) = delete;
  ACPTtrigLightStudies(ACPTtrigLightStudies&&) = delete;
  ACPTtrigLightStudies& operator=(ACPTtrigLightStudies const&) = delete;
  ACPTtrigLightStudies& operator=(ACPTtrigLightStudies&&) = delete;
...
ACPTtrigLightStudies::ACPTtrigLightStudies(fhicl::ParameterSet const& p)
  : EDFilter{p}  // ,
...
bool ACPTtrigLightStudies::filter(art::Event& e)
{
...
void ACPTtrigLightStudies::ResetTTree() {
...
void ACPTtrigLightStudies::beginJob()
{
  // Implementation of optional member function here.
}

void ACPTtrigLightStudies::endJob()
{
  // Implementation of optional member function here.
}

DEFINE_ART_MODULE(ACPTtrigLightStudies)
