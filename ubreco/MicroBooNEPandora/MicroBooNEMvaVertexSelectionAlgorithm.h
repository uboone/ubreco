/**
 *  @file   ubreco/MicroBooNEMvaVertexSelectionAlgorithm.h
 *
 *  @brief  Header file for the mva vertex selection algorithm class.
 *
 *  $Log: $
 */
#ifndef MICROBOONE_MVA_VERTEX_SELECTION_ALGORITHM_H
#define MICROBOONE_MVA_VERTEX_SELECTION_ALGORITHM_H 1
...
/**
 *  @brief  MicroBooNEMvaVertexSelectionAlgorithm class
 */
template<typename T>
class MicroBooNEMvaVertexSelectionAlgorithm : public VertexSelectionBaseAlgorithm
{
public:
    /**
     ...
     */
    MicroBooNEMvaVertexSelectionAlgorithm();
...
typedef MicroBooNEMvaVertexSelectionAlgorithm<AdaBoostDecisionTree> MicroBooNEBdtVertexSelectionAlgorithm;
typedef MicroBooNEMvaVertexSelectionAlgorithm<SupportVectorMachine> MicroBooNESvmVertexSelectionAlgorithm;

//------------------------------------------------------------------------------------------------------------------------------------------

template<typename T>
inline MicroBooNEMvaVertexSelectionAlgorithm<T>::VertexFeatureInfo::VertexFeatureInfo(const float beamDeweighting, const float rPhiFeature, const float energyKick,
...
template<typename T>
inline MicroBooNEMvaVertexSelectionAlgorithm<T>::EventFeatureInfo::EventFeatureInfo(const float eventShoweryness, const float eventEnergy,
...
#endif // #ifndef MICROBOONE_MVA_VERTEX_SELECTION_ALGORITHM_H
