/**
 *  @file   larpandoracontent/LArVertex/MicroBooNEMvaVertexSelectionAlgorithm.h
 *
 ...
 */
template<typename T>
class MicroBooNEMvaVertexSelectionAlgorithm : public MicroBooNETrainedVertexSelectionAlgorithm
{
public:
    /**
