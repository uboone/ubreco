...
// TODO       if (m_outputSettings.m_shouldProduceSlices)
// TODO           produces< art::Assns<recob::Slice, recob::Vertex> >(m_candidateVerticesInstanceLabel);
    }
}
...
// TODO               if (m_outputSettings.m_shouldProduceSlices)
// TODO                   LArPandoraOutput::AddAssociation(evt, this, m_candidateVerticesInstanceLabel, sliceIndex, vertexIndex, outputSlicesToVertices);
...
// TODO    if (m_outputSettings.m_shouldProduceSlices)
// TODO       evt.put(std::move(outputSlicesToVertices), m_candidateVerticesInstanceLabel);
}
