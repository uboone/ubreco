/**
 *  @file   larpandoracontent/LArVertex/MicroBooNETrainedVertexSelectionAlgorithm.h
 *
...
/**
 *  @brief  MicroBooNETrainedVertexSelectionAlgorithm class
 */
class MicroBooNETrainedVertexSelectionAlgorithm : public VertexSelectionBaseAlgorithm
{
public:
    /**
...
inline MicroBooNETrainedVertexSelectionAlgorithm::VertexFeatureInfo::VertexFeatureInfo(const float beamDeweighting, const float rPhiFeature, const float energyKick,
...
inline MicroBooNETrainedVertexSelectionAlgorithm::EventFeatureInfo::EventFeatureInfo(const float eventShoweryness, const float eventEnergy,
