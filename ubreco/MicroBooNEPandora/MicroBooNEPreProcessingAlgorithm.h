/**
 *  @file   ubreco/MicroBooNEPreProcessingAlgorithm.h
 *
 *  @brief  Header file for the microboone pre processing algorithm class.
 *
 *  $Log: $
 */
#ifndef MICROBOONE_PRE_PROCESSING_ALGORITHM_H
#define MICROBOONE_PRE_PROCESSING_ALGORITHM_H 1
...
/**
 *  @brief  MicroBooNEPreProcessingAlgorithm class
 */
class MicroBooNEPreProcessingAlgorithm : public pandora::Algorithm
{
public:
    /**
     *  @brief  Default constructor
     */
    MicroBooNEPreProcessingAlgorithm();
...
#endif // #ifndef MICROBOONE_PRE_PROCESSING_ALGORITHM_H
