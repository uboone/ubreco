...
class WCMCS::WireCellMCS : public art::EDProducer {
public:
...
WCMCS::WireCellMCS::WireCellMCS(fhicl::ParameterSet const & p) : EDProducer{p}
{
  produces<std::vector<TrecchargeblobSpacePoint>>();
}

void WCMCS::WireCellMCS::produce(art::Event &e){
...
DEFINE_ART_MODULE(WCMCS::WireCellMCS)
