...
namespace clusmtool {
  ...
  */
  ...
  public:
    ...
    void AddPriorityAlgo(std::unique_ptr<clusmtool::CPriorityAlgoBase>&& algo) { _priority_algo = std::move(algo); }
  ...
  protected:
    ...
    /// Priority algorithm
    std::unique_ptr<::clusmtool::CPriorityAlgoBase> _priority_algo;
